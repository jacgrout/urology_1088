...
The post-prostatectomy incontinence prevalence for each sub-ICB was calculated differently to the other conditions, by dividing the age and gender specific prevalence calculated for the sub-ICB and dividing this by the overall total list size for the respective sub-ICB. The highest overall prevalence rates are in Nottingham and Nottinghamshire (02Q) sub-ICB and Herefordshire and Worcestershire (18C) sub-ICB. Prevalence rates are the lowest in Leicester, Leicestershire and Rutland (04C) sub-ICB.
...
# select(subicb_ppi, SICBL22CD, SICBL22NM, overall_prev) |>
#   left_join(select(subicb_bph,SICBL22CD, list_size_bph_total)  |>
#   mutate(prev = (overall_prev/list_size_bph_total)*1000) 
...
select(subicb_ppi, SICBL22CD, SICBL22NM, overall_prev) |>
  ...
  cols_label(
    ...
    list_size_bph_total = md("GP List Size"),
    prev = md("Prevalence (per 1000 List Size)")
  ) |>
  cols_align(
    align = "right",
    columns = 2:4

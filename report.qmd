...
The prevalence for each sub-ICB was calculated by dividing the age and gender specific prevalence calculated for the sub-ICB and dividing this by the overall total list size for the respective sub-ICB. The highest overall prevalence rates are in Staffordshire and Stoke on Trent (05V) sub-ICB and Herefordshire and Worcestershire (18C) sub-ICB. Prevalence rates are the lowest in Leicester, Leicestershire and Rutland 04C
...
The BPH activity to need ratios indicate that Nottingham and Nottinghamshire (02Q) sub-ICB and Herefordshire and Worcestershire (18C) sub-ICB have the highest level of activity relative to the underlying need. The lowest level of activity relative to the underlying need is in Leicester, Leicestershire and Rutland 04C sub-ICB and Staffordshire and Stoke-on-Trent (05W) sub-ICB.
...
For the Overactive Bladder condition, the highest overall prevalence rates are in Staffordshire and Stoke on Trent (05G) sub-ICB and Lincolnshire (71E) sub-ICB. Prevalence rates are the lowest in Leicester, Leicestershire and Rutland 04C.
...
The overactive bladder activity to need ratios indicate that Nottingham and Nottinghamshire (02Q) sub-ICB and Leicester, Leicestershire and Rutland (03W) sub-ICB have the highest level of activity relative to the underlying need. The lowest level of activity relative to the underlying level of need is in Leicester, Leicestershire and Rutland (04C) sub-ICB and Birmingham and Solihull (15E) sub-ICB.
...
The post-prostatectomy incontinence prevalence for each sub-ICB was calculated differently to the other conditions, by dividing the age and gender specific prevalence calculated for the sub-ICB and dividing this by the overall total list size for the respective sub-ICB. The highest overall prevalence rates are in Herefordshire and Worcestershire (18C) sub-ICB and Nottingham and Nottinghamshire (02Q) sub-ICB. Prevalence rates are the lowest in Leicester, Leicestershire and Rutland (04C) sub-ICB.
...
The post prostatectomy incontinence activity to need ratios indicate that Staffordshire and Stoke-on-Trent (05V) sub-ICB and Nottingham and Nottinghamshire (02Q) sub-ICB have the highest level of activity relative to the underlying need. The lowest level of activity is in Staffordshire and Stoke-on-Trent (05G) sub-ICB and Lincolnshire (71E) sub-ICB.
...
The Urology outpatient data rarely includes diagnosis codes (only 4% of attendances). Procedures that take place in outpatients are also not consistently recorded. Consequently it's not possible to give a robust picture of activity in relation to these conditions. Below can be seen that high is sub-ICB 71E. Low sub_ICB 04C.
...
midlands_new_op_attends <- midlandsoutpatientssubicb |>
  ...
  #  tm_layout(title = "Urology New Outpatient Attendances per 1000 List Size") +
  tm_borders("grey25", alpha=.5) +
  tm_basemap(server = c('OpenStreetMap'))
```

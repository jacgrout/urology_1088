...
The Urology outpatient data rarely includes diagnosis codes (only 4% of attendances). Procedures that take place in outpatients are also not consistently recorded. Consequently it's not possible to give a robust picture of activity in relation to these conditions. In the map and table below, it can be seen that over a five year peiod (April 2018 to March 2023), the ICB with the largest volume of Urology outpatient new attendances is Lincolnshire (71E) ICB with 261 per 1000 list size population and 04C has the lowest.
...
bph_activity_icb_drugs_mid |>
  ...
  cols_label(
    ...
    presc_anr = md("Pharmacy Activity to Need Ratio")
  ) |>
    tab_header(
